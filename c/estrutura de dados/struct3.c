...
int main()
{
	...
	printf("\nNome: ");
	puts(cliente.nome);
	printf("Endereço: %s, %d - %s, %s, %s", cliente.endereco.logradouro, cliente.num, cliente.bairro, cliente.cidade,cliente.cep);
	printf("\nData de nascimento: %d/%d/%d", cliente.nasc.dia, cliente.nasc.mes, cliente.nasc.ano);
